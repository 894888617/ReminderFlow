...
export const listAppointmentProjects=(calendarId:number,keyword='')=>request<AppointmentProject[]>({url:`/api/calendars/${calendarId}/appointment-projects?calendar_id=${calendarId}&keyword=${encodeURIComponent(keyword)}`,method:'GET'})
